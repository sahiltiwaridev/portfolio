...
export default function About() {
  return (
    <main className="w-1/2 flex flex-col mx-auto gap-12 pt-12">
      ...
      <div className="flex flex-col gap-6">
        ...
        <p>
          ...
          life to someday — just waiting for the right time, the right skills,
          or honestly just a job first. Can't say what's in progress right now —
